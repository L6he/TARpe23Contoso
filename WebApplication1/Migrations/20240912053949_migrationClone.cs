...
{
    /// <inheritdoc />
    public partial class migrationClone : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SocialCredits = table.Column<int>(type: "int", nullable: false),
                    NextPaycheck = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CorpsesResurrected = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
